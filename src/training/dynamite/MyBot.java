...
//        gamestate.getRounds().size() < 100 ? Move.D : getWinnableMove(gamestate)
    ...
    public Move getWinnableMove(Gamestate gamestate){
        ...
        if(gamestate.getRounds().size() > 100){
            ...
            if ((P1_2 == Move.P && P2 == Move.S) || (P1_2 == Move.P || P2 == Move.S)){
                P1 = Move.R;
            } else if ((P1_2 == Move.S && P2 == Move.R) || (P1_2 == Move.S || P2 == Move.R)) {
                P1 = Move.P;
            } else if ((P1_2 == Move.R && P2 == Move.P) || (P1_2 == Move.R || P2 == Move.P)) {
                P1 = Move.S;
            } else if((P1_2 == Move.D && P2 == Move.D) || (P1_2 == Move.D || P2 == Move.D)){
                P1 = Move.W;
            } else if ((P1_2 == Move.W && P2 == Move.W) || (P1_2 == Move.W || P2 == Move.W)) {
                P1 = getRandomMove();
            }
            ...
            if((P1_2 == Move.D && P2 == Move.D) || (P1_2 == Move.D || P2 == Move.D)) {
                P1 = Move.W;
            } else {
                if ((P1_2 == Move.P && P2 == Move.S) || (P1_2 == Move.P || P2 == Move.S)){
                    P1 = Move.R;
